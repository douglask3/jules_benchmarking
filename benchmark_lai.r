...
obss = paste0("../fireMIPbenchmarking/data/benchmarkData/",
              c("lai_0.5x0.5_1982-2009.nc", "lai_0.5x0.5_2000-2005.nc"))
names(obss) = c("AVHRR", "MODIS")
years = list(1997:2009, 2000:2005)
obsLayers = list(1, 1)
obsScale = c(1, 1)

extent = c(-90, -30, -60, 15)
extent = c(-180, 180, -90, 90)
limits_aa = c(0, 0.1, 0.2, 0.5, 1, 2, 3, 4, 5)          
cols_aa =c('#fffbf7','#ecf0e2','#d0e6d1','#a6dbbd','#67cfa9','#36c090',
            '#028a81','#016c59','#014636')

dlimits_aa =  c(-5, -2, -1, -0.5, -0.2, -0.1, 0.1, 0.2, 0.5, 1, 2, 5)                 
...
score_aa = runComparison(mods, obss, 'figs/lai_aa.png', 
...
write.csv(score_aa, "outputs/lai_comparison_global.csv")
