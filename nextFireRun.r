...
outs = cbind("u-cb020_EXP4.61" = c(4.61, 0.1, prior = FALSE),
             ...
             "u-cb020_EXP1.29" = c(1.29, 0.5, prior = FALSE),
             "u-cb020_EXP1.20" = c(1.20, 0.6, prior = FALSE),
             "u-cb020_EXP0.58" = c(0.58, 0.7, prior = FALSE),
             "u-cb020_EXP0.14" = c(0.14, 0.8, prior = FALSE),
             "xxp0.0" = c(0.0, 0.9, prior = TRUE),
             "xxp0.0" = c(9E9, 0.5, prior = TRUE))
outs[2,] = 0.4
extent = c(-180, 180, -90, 90)
pc_sample = 5

param_trans = list("BL_av_BA" = list(c("fun" = modParamTrans.zeroInf, "ParamsGuess" = c(-1),
                                       "funInverse" = modParamTrans.zeroInf.inverse),
                                        prior = list(prior.LogNormal, 1, 1)),
                   "BL_gBurn" = list(c("fun" = modParamTrans.zeroOne, "ParamsGuess" = c(-1),
                                       "funInverse" = modParamTrans.zeroOne.inverse),
                                        prior = list(prior.LogitNormal, 0.4, 1))) #list(prior.Uniform, 0, 1)
